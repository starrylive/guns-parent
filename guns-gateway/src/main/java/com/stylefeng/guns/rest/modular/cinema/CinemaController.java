...
public class CinemaController {
    ...
    /**
     * 根据brandId，districtId，hallType获取影院
     * @param cinemaQueryVO com.stylefeng.guns.api.cinema.vo.CinemaQueryVO 过滤条件
     ...
     * 				"areaName": "朝阳区"
     *
     * 		todo: 跟某个接口一样，这块应该完全交给前端负责，如果涉及多选，靠后端实现明显别扭，白白消耗jvm内存、占用连接
     */
